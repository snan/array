...
class ReshapeTest : APLTest() {
    @Test
    fun simpleReshape() = runBlockingCompat<Unit> {
    ...
    @Test
    fun reshapeDecreaseSize() = runBlockingCompat<Unit> {
    ...
    @Test
    fun reshapeIncreaseSize() = runBlockingCompat<Unit> {
    ...
    @Test
    fun reshapeScalarToSingleDimension() = runBlockingCompat<Unit> {
    ...
    @Test
    fun reshapeScalarToMultiDimension() = runBlockingCompat<Unit> {
